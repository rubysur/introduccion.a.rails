...
* Instalar Rails, crear una nueva aplicación Rails y conectar tu aplicación a una
  base de datos.
...
**Esta guía está basada en Rails 4.0. Algunas partes del código que se muestra
aquí no van a funcionar en nuevas versiones de Rails.**
